...
(1, 1, 1, NULL, 2, 0), -- Klasa Task, Obiekt klasy Task id = 1, właścicielem jest user1
(2, 1, 3, NULL, 2, 0), -- Klasa Task, Obiekt klasy Task id = 3, właścicielem jest user1
(3, 1, 6, NULL, 2, 0), -- Klasa Task, Obiekt klasy Task id = 6, właścicielem jest user1
(4, 1, 2, NULL, 3, 0), -- Klasa Task, Obiekt klasy Task id = 2, właścicielem jest user2
(5, 1, 4, NULL, 3, 0), -- Klasa Task, Obiekt klasy Task id = 4, właścicielem jest user2
(6, 1, 5, NULL, 3, 0), -- Klasa Task, Obiekt klasy Task id = 5, właścicielem jest user2
(7, 1, 7, NULL, 3, 0), -- Klasa Task, Obiekt klasy Task id = 7, właścicielem jest user2
(8, 1, 8, NULL, 3, 0); -- Klasa Task, Obiekt klasy Task id = 8, właścicielem jest user2
...
(1, 1, 1, 2, 1, 1, 1, 0), -- object identity = 1, przypisz READ do użytkownika user1
(2, 2, 1, 2, 1, 1, 1, 0), -- object identity = 2, przypisz READ do użytkownika user1
(3, 3, 1, 2, 1, 1, 1, 0), -- object identity = 3, przypisz READ do użytkownika user1
(4, 4, 1, 3, 1, 1, 1, 0), -- object identity = 2, przypisz READ do użytkownika user2
(5, 5, 1, 3, 1, 1, 1, 0), -- object identity = 7, przypisz READ do użytkownika user2
(6, 6, 1, 3, 1, 1, 1, 0), -- object identity = 4, przypisz READ do użytkownika user2
(7, 7, 1, 3, 1, 1, 1, 0), -- object identity = 5, przypisz READ do użytkownika user2
(8, 8, 1, 3, 1, 1, 1, 0); -- object identity = 8, przypisz READ do użytkownika user2
